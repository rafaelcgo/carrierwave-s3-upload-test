...
ActiveRecord::Schema.define(version: 20131024004551) do
  ...
  create_table "photo_zips", force: true do |t|
    t.string   "file"
    t.integer  "parent_id"
  ...
  add_index "photo_zips", ["parent_id", "parent_type"], name: "index_photo_zips_on_parent_id_and_parent_type", using: :btree
